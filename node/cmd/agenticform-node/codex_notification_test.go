...
func TestShouldForwardNotificationIncludesAssistantDeltas(t *testing.T) {
	for _, method := range []string{"item/started", "item/agentMessage/delta", "item/commandExecution/outputDelta", "command/exec/outputDelta", "item/completed", "rawResponseItem/completed", "turn/completed"} {
